...
\begin{itemize}
  \item \texttt{D:\\MEDIA} (Movies, TV\_Shows, Music)
  \item \texttt{D:\\FAMILY\_BACKUP} (cartelle private per utente)
  \item \texttt{D:\\DEV} (ISO, VMs, Repos)
  \item \texttt{D:\\PUBLIC} (scambio temporaneo)
  \item \texttt{D:\\APP\_DATA} (persistenza applicazioni container)
\end{itemize}
...
BKP-Files-Crit & \texttt{D:\\FAMILY\_BACKUP}, \texttt{D:\\DEV}, \texttt{D:\\APP\_DATA} & USB + sync cloud & Giornaliero 04:00 & 30 giorni \\
BKP-Media-Wkly & \texttt{D:\\MEDIA} & USB & Settimanale & 2 versioni \\
...
Reinstallazione host su NVMe, riaggancio Storage Spaces, import VM da \texttt{D:\\DEV\\VMs}, riconfigurazione rete/share.
